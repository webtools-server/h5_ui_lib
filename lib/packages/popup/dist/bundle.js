...
/*``*/) {
  var out = '<div class="' + it.classes.wrap + '"> <div class="ui-overlay ' + it.classes.mask + '"></div> <div class="ui-popup"> <div class="ui-popup__title ' + it.classes.title + '">';if (it.title) {
    ...
    out += ' <div et="click:close" class="ui-popup__fn-button"><i class="' + it.classes.close + '"></i></div> ';
...
function calcContentHeight(topHeight, titleHeight) {
  topHeight = topHeight || 296;
  titleHeight = titleHeight || 104;
...
var Popup = function () {
  ...
  createClass(Popup, [{
    ...
    value: function _init() {
      ...
      this.$el.find(selectors.content).css('max-height', calcContentHeight(this.options.paddingTop, this.options.titleHeight));
      this._bindEvent();
    }
