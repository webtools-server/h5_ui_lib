...
function anonymous(it
/**/) {
  var out = '<div class="ui-picker__content"> <div class="ui-picker__mask"></div> <div class="ui-picker__list"> ';var arr1 = it.list;if (arr1) {
    var item,
        index = -1,
...
/**/) {
  var out = '<div et="click:close" class="ui-popup__fn-button ui-popup__fn-button--left"><i class="ui-icon-close"></i></div>' + it.title + '<div class="ui-popup__fn-button ui-popup__fn-button--hl">确定</div>';return out;
}
